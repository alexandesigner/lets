install:
	...
	meteor npm install -S babel-runtime@6.23.0 meteor-node-stubs@0.2.0 vue@2.3.4 vue-meteor-tracker@1.2.3 vue-router@2.5.3 element-ui@1.3.6 element-theme-default@1.3.7 bcrypt@1.0.2 @cleverbeagle/seeder@1.1.0
